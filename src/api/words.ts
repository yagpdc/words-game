...
const PROD_API_URL =
  typeof window !== "undefined"
    ? `${window.location.origin}/api/words-backend`
    : ""
...
export const WORDS_ENDPOINTS = {
  ...
  coopJoinRoom: (roomId: string) =>
    `${WORDS_API_BASE_URL}/infinity/coop/join-room/${roomId}`,
  coopRoomStatus: (roomId: string) =>
    `${WORDS_API_BASE_URL}/infinity/coop/room/${roomId}`,
